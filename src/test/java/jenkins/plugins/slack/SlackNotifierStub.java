...
public class SlackNotifierStub extends SlackNotifier {
    ...
    public SlackNotifierStub(String teamDomain, String authToken, String authTokenCredentialId, String room, String apiToken,
        ...
        super(teamDomain, authToken, authTokenCredentialId, room, apiToken, sendAs, startNotification, notifyAborted, notifyFailure,
