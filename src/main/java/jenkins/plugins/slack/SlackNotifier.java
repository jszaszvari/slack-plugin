...
public class SlackNotifier extends Notifier {
    ...
    public SlackNotifier(final String teamDomain, final String authToken, final String room, final String authTokenCredentialId, final String apiToken,
    ...
    public SlackService newSlackService(AbstractBuild r, BuildListener listener) {
        ...
        return new StandardSlackService(teamDomain, authToken, authTokenCredentialId, room, apiToken);
    }
    ...
    public static class DescriptorImpl extends BuildStepDescriptor<Publisher> {
        ...
        public SlackNotifier newInstance(StaplerRequest sr, JSONObject json) {
            ...
            return new SlackNotifier(teamDomain, token, room, tokenCredentialId, apiToken, sendAs, startNotification, notifyAborted,
        ...
        SlackService getSlackService(final String teamDomain, final String authToken, final String authTokenCredentialId, final String room, final String apiToken) {
            return new StandardSlackService(teamDomain, authToken, authTokenCredentialId, room, apiToken);
        }
        ...
        public FormValidation doTestConnection(@QueryParameter("slackTeamDomain") final String teamDomain,
            ...
            try {
                ...
                SlackService testSlackService = getSlackService(targetDomain, targetToken, targetTokenCredentialId, targetRoom, targetApiToken);
